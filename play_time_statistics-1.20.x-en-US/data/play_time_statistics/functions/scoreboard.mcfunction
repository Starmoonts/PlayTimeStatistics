...
execute unless data storage play_time_statistics:config Init run scoreboard objectives modify time_minutes_persist displayname {"text":"[Minutes]","color":"green"}

execute unless data storage play_time_statistics:config Init run scoreboard objectives add time_hours dummy

execute unless data storage play_time_statistics:config Init run scoreboard objectives modify time_hours displayname {"text":"[Hours]","color":"green"}
